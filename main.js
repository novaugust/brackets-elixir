...
define(function (require, exports, module) {
    ...
    var replPanel = makePanel(replPanelHtml, "brackets-elixir-repl",
        "brackets-elixir-repl-panel", "Elixir - REPL");
    
    // Create an output panel for mix operations
    var mixOutputPanel = makePanel(outputPanelHtml, "brackets-elixir-output",
        "brackets-elixir-output-panel", "Elixir - Output");
    
    // Define the extension specific preferences
    var prefs = PreferencesManager.getExtensionPrefs("brackets-elixir");
    ...
    var elixirMenu = Menus.addMenu("Elixir", "brackets-elixir.elixirmenu");
    ...
    ["compile", "test"].forEach(function (mixArgument, i, arr) {
        var command = CommandManager.register(
            ...
            "brackets-elixir.mix-" + mixArgument, // command name, e.g. brackets-elixir.mix-compile
            function () {
